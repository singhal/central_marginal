...
f = read.csv("~/Dropbox (Personal)/publications/Sphenomorphine_Gene_Flow/data/divergence/divergence.all_OTUs.csv", stringsAsFactors = F)
...
n = read.csv("~/Dropbox (Personal)/publications/Sphenomorphine_Gene_Flow/data/envirospatial/range_data.csv", stringsAsFactors = F)
...
phy = read.tree("~/Dropbox (Personal)/publications/Sphenomorphine_Gene_Flow/data/phylogeny/beast_ucln_31July17/otu.tre")
...
bestmod = phylolm("rho ~ founder", data=d4l, phy2, model="lambda", lower.bound=0)
summary(bestmod)
